...
public struct Application: Sendable, ConfigurableProxy {
  ...
  public func beginBackgroundTask(
    withName taskName: String? = nil, expirationHandler handler: (() -> Void)? = nil) -> UIBackgroundTaskIdentifier
  {
...
extension Application {
  public struct Implementation: Sendable {
    ...
    @FunctionProxy public var requestSceneSessionActivation:
      @MainActor @Sendable (
        UISceneSession?, NSUserActivity?, UIScene.ActivationRequestOptions?, ((Error) -> Void)?) -> Void
    ...
    init(
      ...
      @Sendable @MainActor (
        UISceneSession, UISceneDestructionRequestOptions?, ((Error) -> Void)?) -> Void
      >,
