...
import XCTestDynamicOverlay
  ...
  public struct Device: Sendable, ConfigurableProxy {
    ...
    init(
      ...
      model: @escaping @autoclosure () -> String,
      localizedModel: @escaping @autoclosure () -> String,
      systemName: @escaping @autoclosure () -> String,
      systemVersion: @escaping @autoclosure () -> String,
      identifierForVendor: @escaping @autoclosure () -> UUID?,
      screenBounds: @escaping @autoclosure () -> CGRect,
      screenScale: @escaping @autoclosure () -> CGFloat,
      preferredContentSizeCategory: @escaping @autoclosure () -> String,
      layoutDirection: @escaping @autoclosure () -> WKInterfaceLayoutDirection,
      wristLocation: @escaping @autoclosure () -> WKInterfaceDeviceWristLocation,
      crownOrientation: @escaping @autoclosure () -> WKInterfaceDeviceCrownOrientation,
      isBatteryMonitoringEnabled: (get: @Sendable () -> Bool, set: @Sendable (Bool) -> Void),
      batteryState: @escaping @autoclosure () -> WKInterfaceDeviceBatteryState,
      batteryLevel: @escaping @autoclosure () -> Float,
      waterResistanceRating: @escaping @autoclosure () -> WKWaterResistanceRating,
      isWaterLockEnabled: @escaping @autoclosure () -> Bool,
      supportsAudioStreaming: @escaping @autoclosure () -> Bool,
      ...
      self._implementation = .init(
        ...
        isBatteryMonitoringEnabled: .init(isBatteryMonitoringEnabled),
