...
public struct UserNotificationCenter: Sendable, ConfigurableProxy {
  public struct Implementation: Sendable {
    ...
    @FunctionProxy public var requestAuthorization: @Sendable (UNAuthorizationOptions) async throws -> Bool
    ...
    @FunctionProxy public var pendingNotificationRequests: @Sendable () async -> [UNNotificationRequest]
    ...
    @FunctionProxy public var setNotificationCategories: @Sendable (Set<UNNotificationCategory>) -> Void
    @FunctionProxy public var notificationCategories: @Sendable () async -> Set<UNNotificationCategory>
  }
